...
#'  values.
#' @return A list variable with (1) the loaded data, (2) the loaded mapping
#'  file, and (3) (if .biom format) the loaded taxonomies
#' @examples 
#' \dontrun{
...
#'                      package = 'mctoolsr')
#' input = load_taxa_table(tax_table_fp, map_fp, 'Sample_type', 
#'                         filter_vals = 'Lettuce')
#' }
...
#' @examples 
#' \dontrun{
#' loaded_dm = load_dm(system.file('extdata', 'fruits_veggies_dm.txt',
#'                     package = 'mctoolsr'), 
#'         system.file('extdata', 'fruits_veggies_metadata.txt', 
#'                     package = 'mctoolsr'),
#'         filter_cat = "Sample_type", filter_vals = "Spinach")
#'   
#' }
...
#' @examples 
#' \dontrun{
#' load_2_dms(system.file('extdata', 'fruits_veggies_dm.txt',
#'                        package = 'mctoolsr'), 
#'            "filepath_to_dissim_matrix2.txt", 
#'            system.file('extdata', 'fruits_veggies_metadata.txt', 
#'                        package = 'mctoolsr'), 
#'            "Sample_type", filter_vals = "Spinach")
#' }
...
#' @examples 
#' \dontrun{
#' filter_data(input = input, filter_cat = "Sample_type", 
...
################################################################################
##########  The Function Below Does Not Work And Does Not Exist ################
################################################################################
...
#'  file as generated by \code{load_dm()} or \code{calc_dm()} 
...
#' @examples 
#' \dontrun{
#' filtered_dm = filter_dm(loaded_dm, "Farm_type", filter_vals = "organic")
#' }
...
#' @examples 
#' \dontrun{
#' match_datasets(input, loaded_taxa_table2)
#' }
...
#' @examples 
#' \dontrun{
#' export_otu_table(input, 'desired_file_path', 
#'                  system.file('extdata', 'fruits_veggies_metadata.txt', 
#'                              package = 'mctoolsr'))
#' }
